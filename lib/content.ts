...
export const content = {
  ...
  about: {
    ...
    metaDescription:
      "Learn about FICS Motorcycles, our team, and our commitment to the riding community.",
    ...
    values: [
      {
        ...
        description:
          "Decades of combined expertise in motorcycle service, repair, and customisation.",
      },
      {
        title: "Certified Technicians",
        description:
          "Our team is trained and certified to work on all major motorcycle brands.",
      },
      {
        title: "Community Focused",
        description:
          "We're active members of the local riding community and support rider events.",
      },
      {
        title: "Quality Work",
        description:
  ...
  servicesPage: {
    ...
    metaDescription:
      "Expert motorcycle services in Coppull. Maintenance, repairs, MOT, performance upgrades, and more. Contact us for pricing.",
    ...
    items: [
      {
        ...
        description:
          "Keep your bike running smoothly with regular maintenance services including oil changes, tyre changes, brake service, chain adjustments, and fluid checks.",
        price: "Contact us for pricing",
      },
      {
        title: "Engine Repair & Rebuild",
        description:
          "Expert diagnostics and repair for all engine issues. From minor fixes to complete engine rebuilds, our certified technicians have you covered.",
        price: "Custom Quote",
      },
      {
        title: "Performance Upgrades",
        description:
          "Unlock your bike's potential with exhaust systems, air filters, ECU tuning, suspension upgrades, and dyno tuning services.",
        price: "Contact us for pricing",
      },
      {
        title: "Custom Fabrication",
        description:
          "Bring your vision to life with custom exhaust work, seat modifications, handlebar fabrication, and unique parts manufacturing.",
        price: "Custom Quote",
      },
      {
        title: "Electrical Services",
        description:
          "Complete electrical diagnostics and repair, lighting upgrades, battery service, and custom wiring for accessories.",
        price: "Contact us for pricing",
      },
      {
        title: "Detailing & Ceramic Coating",
        description:
          "Full wash and detail, paint correction, ceramic coating application, chrome polishing, and leather conditioning.",
        price: "Contact us for pricing",
      },
    ],
  ...
  contactPage: {
    ...
    metaDescription:
      "Get in touch with FICS Motorcycles. Visit us at 164 Preston Road, Coppull, call 01257 793318, or send us a message.",
  ...
  revvi: {
    ...
    metaDescription:
      "Authorised Revvi electric balance bike dealer in Coppull. Electric bikes for children aged 3-12. Expert advice, test rides, and full after-sales support.",
    ...
    benefits: [
      {
        ...
        description:
          "Silent, emission-free riding perfect for young riders learning the basics",
      },
      {
        title: "Safety First",
        description:
          "Adjustable speed settings and responsive brakes designed for children",
      },
      {
        title: "Build Confidence",
        description:
          "Progressive learning system helps kids develop riding skills at their own pace",
      },
    ],
    ...
    models: [
      ...
      {
        name: "Revvi Sixteen XL",
        age: "6-12 years",
        features: [
          '16" wheels',
          "Advanced controls",
          "Up to 120 mins ride time",
        ],
        image: "/revvi-sixteen-xl.jpg",
      },
      {
        name: "Revvi Eighteen",
        age: "6-10 years",
  ...
  stomp: {
    ...
    metaDescription:
      "Authorised Stomp pit bike dealer in Coppull. Quality pit bikes and mini motos for all ages and skill levels.",
    ...
    benefits: [
      {
        title: "Built to Last",
        description:
          "Robust construction and quality components designed to handle the rigours of pit bike riding",
      },
      {
        title: "All Ages",
        description:
          "A model for every rider from young beginners to experienced adults",
      },
      {
        title: "Great Value",
        description:
          "Competitive pricing without compromising on performance or reliability",
      },
    ],

    modelsHeading: "Available Models",
    modelsSubheading:
      "Find the right Stomp for your riding style and experience",
    agesPrefix: "Ages",
    getDetailsButton: "Get Details",
    models: [
      {
  ...
  thumpstar: {
    ...
    metaDescription:
      "Authorised Thumpstar pit bike dealer in Coppull. Premium pit bikes renowned for performance and durability.",
    badge: "Official Authorised Dealer",
    ...
    benefits: [
      {
        title: "Race Proven",
        description:
          "Developed and tested in competitive motorsport environments for maximum performance",
      },
      {
        title: "Premium Quality",
        description:
          "High-spec components and precision engineering set Thumpstar apart from the competition",
      },
      {
        title: "Full Support",
        description:
          "Backed by our expert team for servicing, parts, and technical advice",
      },
    ],

    modelsHeading: "Available Models",
    modelsSubheading:
      "Explore the Thumpstar range — built for riders who demand more",
    agesPrefix: "Ages",
    getDetailsButton: "Get Details",
    models: [
      {
  ...
  mucOff: {
    ...
    metaDescription:
      "Official Muc-Off stockist in Coppull. Premium motorcycle cleaning, care, and maintenance products.",
    ...
    benefits: [
      {
        title: "World's Best",
        description:
          "Trusted by professional race teams and everyday riders across the globe",
      },
      {
        title: "Biodegradable",
        description:
          "Environmentally friendly formulas that are tough on dirt but safe for the planet",
      },
      {
        title: "Full Range",
        description:
          "Everything you need to clean, protect, and maintain your bike in one brand",
      },
    ],

    modelsHeading: "Product Ranges",
    modelsSubheading:
      "Muc-Off makes everything your bike needs to stay clean and protected",
    agesPrefix: "",
